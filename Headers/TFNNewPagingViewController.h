...
@class NSArray, NSIndexPath, NSMutableArray, NSMutableDictionary, NSNumber, NSString, TFNNewPagingScrollView, UIKeyCommand, UITapGestureRecognizer, UIView, UIViewController;
@protocol TFNNewPagingViewControllerDataSource, TFNNewPagingViewControllerDelegate;
...
@interface TFNNewPagingViewController : TFNViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    TFNNewPagingScrollView *_contentScrollView;
...
@property(nonatomic) long long cachingMode; // @synthesize cachingMode=_cachingMode;
...
@property(nonatomic) __weak id <TFNNewPagingViewControllerDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property(nonatomic) __weak id <TFNNewPagingViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) TFNNewPagingScrollView *contentScrollView; // @synthesize contentScrollView=_contentScrollView;
- (void).cxx_destruct;
...
- (id)_visibleIndexPathsForCachingMode:(long long)arg1;
