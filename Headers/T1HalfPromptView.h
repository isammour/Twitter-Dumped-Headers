...
@class NSArray, NSString, T1PromptTextSpec, TFNAttributedTextView, TFNToolbar, UIButton, UIImage;
...
@interface T1HalfPromptView : UIView <T1PromptView>
{
    ...
    NSArray *_buttons;
    double _toolbarBottomOffset;
}

@property(nonatomic) double toolbarBottomOffset; // @synthesize toolbarBottomOffset=_toolbarBottomOffset;
