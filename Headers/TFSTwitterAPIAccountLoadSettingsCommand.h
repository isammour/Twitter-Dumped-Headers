...
@interface TFSTwitterAPIAccountLoadSettingsCommand : TFSTwitterAPICommand
{
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 account:(id)arg2 source:(unsigned long long)arg3 completionBlock:(CDUnknownBlockType)arg4;
