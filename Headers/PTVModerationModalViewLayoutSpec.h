...
+ (struct CGRect)ExampleContainerFrameWithSubtitleSize:(struct CGSize)arg1 InterfaceOrientation:(long long)arg2 ModalViewSize:(struct CGSize)arg3;
+ (struct CGRect)ExampleLabelFrameWithSubtitleSize:(struct CGSize)arg1 InterfaceOrientation:(long long)arg2 ModalViewSize:(struct CGSize)arg3;
+ (id)ExampleLabelAttributed;
+ (struct CGRect)SubtitleFrameWithSize:(struct CGSize)arg1 InterfaceOrientation:(long long)arg2 ModalViewSize:(struct CGSize)arg3;
...
+ (struct CGSize)ModalViewSizeThatFits:(struct CGSize)arg1 SubtitleLabelSize:(struct CGSize)arg2 ConfirmationButtonHeight:(double)arg3 InterfaceOrientation:(long long)arg4;
...
+ (struct UIEdgeInsets)ExampleOuterSpacing:(long long)arg1;
+ (struct UIEdgeInsets)SubtitleOuterSpacing:(long long)arg1;
