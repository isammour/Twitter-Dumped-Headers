...
@class NSString, TFNNavigationBarOverlayView, TFNNavigationBarProgressView, UIColor, UIImage, UIImageView, UIView;
...
@property(readonly, nonatomic) TFNNavigationBarProgressView *progressView; // @synthesize progressView=_progressView;
@property(readonly, nonatomic) UIImageView *customShadowImageView; // @synthesize customShadowImageView=_customShadowImageView;
...
- (_Bool)_setViewWithFrame:(struct CGRect)arg1 hidden:(_Bool)arg2 withinView:(id)arg3;
