...
@class NSString, NSURL, T1WebViewLogger, T1WebViewRedirectTracker, TFNTwitterAccount, TFNTwitterScribeViewControllerEventObserver, TFNTwitterStatus, UIScreenEdgePanGestureRecognizer;

@interface T1SafariViewController : SFSafariViewController <SFSafariViewControllerDelegate, TFNPresented, T1JumpBackToHomeTimelineBehavior, TFNViewControllerVisibility, T1WebBrowserViewController>
{
    ...
    TFNTwitterScribeViewControllerEventObserver *_scribeVCEventObserver;
    _Bool _visible;
