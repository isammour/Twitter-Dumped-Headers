...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 lastSeenEventID:(id)arg3 trustedLastSeenEventID:(id)arg4 untrustedLastSeenEventID:(id)arg5 source:(unsigned long long)arg6 completionBlock:(CDUnknownBlockType)arg7;
