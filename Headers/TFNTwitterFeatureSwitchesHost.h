...
@class NSHashTable, NSMapTable, NSMutableDictionary, NSString, TFNBackgroundTaskManager, TFNTwitterFeatureSwitchesAATest, TFNTwitterFeatureSwitchesHostBridgeScribeDelegate;
...
@property(retain, nonatomic) TFNBackgroundTaskManager *backgroundTaskManager; // @synthesize backgroundTaskManager=_backgroundTaskManager;
...
@property(retain, nonatomic) TFNTwitterFeatureSwitchesAATest *aaTest; // @synthesize aaTest=_aaTest;
