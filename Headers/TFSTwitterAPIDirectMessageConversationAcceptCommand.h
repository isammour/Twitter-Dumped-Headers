...
@interface TFSTwitterAPIDirectMessageConversationAcceptCommand : TFSTwitterAPICommand
{
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 conversationID:(id)arg3 requestID:(id)arg4 source:(unsigned long long)arg5 completionBlock:(CDUnknownBlockType)arg6;
