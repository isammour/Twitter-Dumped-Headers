...
@interface TFNTwitterStatusCarousel : NSObject <TFSTwitterTimelinePlistSerialization, TFNTwitterUserRelatable, TFNTwitterTimelineObject, TFNTwitterMutableDismissibleItem>
{
    _Bool _dismissing;
...
@property(retain, nonatomic) TFNTwitterModuleFooter *footer; // @synthesize footer=_footer;
...
@property(readonly, nonatomic) NSString *carouselID;
