...
@interface T1DirectMessageConversationHeaderViewController : TFNViewController
{
    ...
    // Error parsing type: , name: settingsBarButtonItem.storage
    // Error parsing type: , name: detailsToolbar.storage
    // Error parsing type: , name: secretConversationBanner.storage
}
...
- (void)conversationDidRename:(id)arg1;
