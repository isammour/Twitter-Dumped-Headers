...
@class NSString, T1AnimatedGIFImageView, TFNAnimatedGifImage, TFNFoundMediaFetchOperation, TFNFoundMediaObject, UIColor, UILongPressGestureRecognizer;
...
@property(retain, nonatomic) TFNFoundMediaObject *foundMediaObject; // @synthesize foundMediaObject=_foundMediaObject;
