...
@class NSDate, TFNTwitterStatus, TFSTwitterAPIReactiveBlendingRelatedArticlesInfo;
...
@interface TFNTwitterRelatedArticlesReaction : NSObject
{
    ...
    TFSTwitterAPIReactiveBlendingRelatedArticlesInfo *_content;
...
@property(retain, nonatomic) TFSTwitterAPIReactiveBlendingRelatedArticlesInfo *content; // @synthesize content=_content;
