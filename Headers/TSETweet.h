...
#import <TwitterShareExtensionUI/NSCopying-Protocol.h>
...
+ (id)emptyTweet;
+ (id)twitterTextParser;
+ (void)setTwitterTextParser:(id)arg1;
+ (Class)twitterText;
...
- (id)characterInfo;
- (float)_tseui_languageBasedScaleFactor;
- (float)_tseui_scaleFactor;
