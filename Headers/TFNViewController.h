...
@class NSHashTable, NSString, TFNNavigationItem, UIImpactFeedbackGenerator, UINotificationFeedbackGenerator, UISelectionFeedbackGenerator;

@interface TFNViewController : UIViewController <TFNViewControllerVisibility, TFNHapticFeedback>
{
    TFNNavigationItem *_navigationItem;
...
@property(readonly, nonatomic) _Bool shouldPreventAmbientNotificationBanners;
