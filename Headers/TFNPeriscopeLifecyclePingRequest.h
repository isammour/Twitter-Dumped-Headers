...
@interface TFNPeriscopeLifecyclePingRequest : TFNPeriscopeLifecycleRequest
{
...
- (id)initWithBroadcast:(id)arg1 periscopeAccount:(id)arg2 session:(id)arg3 authenticated:(_Bool)arg4;
