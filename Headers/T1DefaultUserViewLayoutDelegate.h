...
+ (id)_bioTextAttributesWithLayoutMetrics:(id)arg1;
+ (double)heightForUserViewModel:(id)arg1 account:(id)arg2 cellStyle:(long long)arg3 actionControlProvider:(id)arg4 avatarSize:(struct CGSize)arg5 showBio:(_Bool)arg6 bioMaxLines:(unsigned long long)arg7 showUserBlocked:(_Bool)arg8 showDesignatorBadge:(_Bool)arg9 expanded:(_Bool)arg10 layoutMetrics:(id)arg11;
