...
- (double)_t1_collectionViewRightInset;
- (double)_t1_collectionViewLeftInset;
- (id)_t1_providedLayoutMetrics;
- (struct CGRect)_t1_absoluteRectForItemAtIndexPath:(id)arg1 contentEdgeInsets:(struct UIEdgeInsets)arg2;
