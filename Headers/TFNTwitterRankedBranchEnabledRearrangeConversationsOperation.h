...
- (void)_addNRepliesItemToStreamObjectsIfNeeded:(id)arg1 replyRenderCountForCurrentBranch:(long long *)arg2 status:(id)arg3 currentBranch:(id)arg4 lastBranch:(id *)arg5;
- (void)_prependStreamObject:(id)arg1 toStreamObjects:(id)arg2 lastBranchedStatus:(id *)arg3 currentBranch:(id)arg4 replyRenderCountForCurrentBranch:(long long *)arg5 lastBranch:(id *)arg6;
