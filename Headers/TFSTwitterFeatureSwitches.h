...
+ (_Bool)initializeWithContentsOfFile:(id)arg1 forDevice:(id)arg2 isUsingVoiceOver:(_Bool)arg3 signedOutScribeDelegate:(id)arg4 logger:(id)arg5 host:(id)arg6 overrides:(_Bool)arg7 instrumentation:(_Bool)arg8 mode:(long long)arg9 error:(id *)arg10;
