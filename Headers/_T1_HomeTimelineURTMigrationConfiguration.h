...
@interface _T1_HomeTimelineURTMigrationConfiguration : NSObject <T1URTHomeTimelineMigrationConfiguration>
{
    ...
    // Error parsing type: {?="mutex"{_opaque_pthread_mutex_t="__sig"q"__opaque"[56c]}"predicate"{atomic_flag="_Value"AB}}, name: _configSetupTransientDispatchOnceToken
}
...
// Property attributes: T{?={_opaque_pthread_mutex_t=q[56c]}{atomic_flag=AB}},R,N,V_configSetupTransientDispatchOnceToken
