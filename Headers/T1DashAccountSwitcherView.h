...
@class NSArray, T1AppBadging, T1DashAccountSwitcherMoreBubble, TFNTwitterAccount;

@interface T1DashAccountSwitcherView : UIView
{
    _Bool _overflowButtonEnabled;
    _Bool _overflowButtonAlwaysVisible;
    TFNTwitterAccount *_account;
    NSArray *_accounts;
    NSArray *_visibleAccounts;
    CDUnknownBlockType _progressBlock;
    CDUnknownBlockType _dismissDashBlock;
...
@property(nonatomic) _Bool overflowButtonAlwaysVisible; // @synthesize overflowButtonAlwaysVisible=_overflowButtonAlwaysVisible;
@property(nonatomic) _Bool overflowButtonEnabled; // @synthesize overflowButtonEnabled=_overflowButtonEnabled;
...
@property(copy, nonatomic) CDUnknownBlockType dismissDashBlock; // @synthesize dismissDashBlock=_dismissDashBlock;
