...
#import <T1Twitter/TFNTwitterFormAutocompleteControllerDelegate-Protocol.h>

@class NSArray, NSMutableDictionary, NSString, TFNAutocompleteViewController, TFNButton, TFNForm, TFNFormAppearance, TFNFormField, TFNFormFieldCell, TFNFormView, TFNTwitterFormAutocompleteController, UIBarButtonItem, UICollectionViewFlowLayout;

@interface TFNFormViewController : TFNItemsDataViewController <TFNFormDelegate, TFNFormFieldCellDelegate, TFNTwitterFormAutocompleteControllerDelegate, TFNAutocompleteViewControllerDelegate>
{
    ...
    TFNTwitterFormAutocompleteController *_autocompleteController;
...
@property(readonly, nonatomic) TFNTwitterFormAutocompleteController *autocompleteController; // @synthesize autocompleteController=_autocompleteController;
...
@property(nonatomic, getter=isAnimatingAutocompleteOut) _Bool animatingAutocompleteOut; // @synthesize animatingAutocompleteOut=_animatingAutocompleteOut;
...
@property(readonly, nonatomic) TFNAutocompleteViewController *autocompleteViewController; // @synthesize autocompleteViewController=_autocompleteViewController;
...
- (struct CGRect)_tfn_visibleAutocompleteFrameForBounds:(struct CGRect)arg1;
- (void)_tfn_showAutocomplete:(_Bool)arg1;
...
- (double)titleWidthForSection:(long long)arg1;
- (void)_animateFormViewForFormFieldCell:(id)arg1;
- (void)_adjustFormViewIfNecessaryForFormFieldCell:(id)arg1;
@property(readonly, nonatomic) long long autocompleteSourceType;
