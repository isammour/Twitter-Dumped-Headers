...
@interface T1NativeBasicAppCardViewModel : NSObject <TFNTwitterCardContextModel, T1NativeAppCardDetailsViewModel, T1NativeCardImageResourceProvider>
{
    _Bool _minimumRatingThreshold;
    NSString *_accountID;
