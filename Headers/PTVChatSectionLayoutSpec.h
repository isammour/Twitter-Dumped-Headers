...
+ (struct CGRect)CandyImageFrameWithDisplayStyle:(int)arg1 UsernameLabelSize:(struct CGSize)arg2 ContainerSize:(struct CGSize)arg3;
+ (id)CandyImageForDisplayStyle:(int)arg1;
+ (id)SuperfanImage;
+ (id)ContributorImage;
+ (id)FollowingIcon;
...
+ (struct CGRect)VipBadgeImageFrameWithHidden:(_Bool)arg1 CandyDisplayStyle:(int)arg2 UsernameLabelSize:(struct CGSize)arg3 VipBadgeSize:(struct CGSize)arg4 ContainerSize:(struct CGSize)arg5;
+ (struct CGRect)AvatarColorBackgroundFrame:(struct CGSize)arg1;
+ (struct CGRect)AvatarFrame:(struct CGSize)arg1;
+ (struct CGSize)UsernameSize:(id)arg1 BlockState:(int)arg2 UseLargeChatFont:(_Bool)arg3 ContainerSize:(struct CGSize)arg4;
+ (id)UsernameAttributed:(id)arg1 BlockState:(int)arg2 UseLargeChatFont:(_Bool)arg3;
+ (struct CGRect)UsernameFrame:(struct CGSize)arg1 CandyDisplayStyle:(int)arg2;
...
+ (struct CGRect)ChatMessageFrameWithUsernameSize:(struct CGSize)arg1 CandyDisplayStyle:(int)arg2 containerSize:(struct CGSize)arg3;
+ (struct CGRect)ChatContainerView:(id)arg1 UsernameLabelSize:(struct CGSize)arg2 CandyDisplayStyle:(int)arg3 IsVipBadged:(_Bool)arg4 VipBadgeSize:(struct CGSize)arg5 UseLargeChatFont:(_Bool)arg6 ContainerSize:(struct CGSize)arg7;
...
+ (id)AlertAttributed:(id)arg1 Message:(id)arg2 RenderNewUserWelcomeMessage:(_Bool)arg3 UseLargeChatFont:(_Bool)arg4;
+ (struct CGSize)AlertLabelSize:(id)arg1 Message:(id)arg2 IsSuperFan:(_Bool)arg3 RenderNewUserWelcomeMessage:(_Bool)arg4 UseLargeChatFont:(_Bool)arg5 TableViewSize:(struct CGSize)arg6;
...
+ (struct CGRect)ShareBroadcastButtonFrame:(_Bool)arg1;
...
+ (struct CGRect)ChatPromptLabelFrame:(struct CGSize)arg1;
...
+ (double)ScrubbingPromptCellHeightTableViewSize:(struct CGSize)arg1 UseLargeChatFont:(_Bool)arg2;
...
+ (double)AlertCellHeight:(id)arg1 Message:(id)arg2 IsSuperfan:(_Bool)arg3 RenderNewUserWelcomeMessage:(_Bool)arg4 UseLargeChatFont:(_Bool)arg5 TableViewSize:(struct CGSize)arg6;
