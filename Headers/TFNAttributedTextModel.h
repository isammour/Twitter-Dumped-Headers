...
@property(copy, nonatomic) NSAttributedString *attributedTruncationString; // @synthesize attributedTruncationString=_attributedTruncationString;
...
- (struct __CTParagraphStyle *)_createCoreTextParagraphStyleWithSettingCount:(unsigned long long)arg1 settings:(const struct CTParagraphStyleSetting *)arg2;
- (struct __CTParagraphStyle *)_createCoreTextParagraphStyleForCTBase:(struct __CTParagraphStyle *)arg1 overrideSettingCount:(unsigned long long)arg2 overrideSettings:(const struct CTParagraphStyleSetting *)arg3;
- (struct __CTParagraphStyle *)_createCoreTextParagraphStyleForBase:(id)arg1 overrideSettingCount:(unsigned long long)arg2 overrideSettings:(const struct CTParagraphStyleSetting *)arg3;
- (id)_coreTextAttributedString;
- (struct __CTFrame *)_coreTextFrameCreatedWithAttributedString:(id)arg1;
- (_Bool)_sizeRequiresRelayout:(struct CGSize)arg1;
