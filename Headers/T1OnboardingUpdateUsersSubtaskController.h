...
@class TFNOnboardingUpdateUsersSubtask;
@protocol T1OnboardingSubtaskControllerDelegate;

@interface T1OnboardingUpdateUsersSubtaskController : T1OnboardingSubtaskController
{
    TFNOnboardingUpdateUsersSubtask *_subtask;
