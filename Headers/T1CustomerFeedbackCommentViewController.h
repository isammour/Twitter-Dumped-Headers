...
@class NSNumber, NSString, TFNBarButtonItem, TFNTextView, TFNToolbar, TFNTwitterAccount, TFNTwitterUser, UILabel;
...
@property(retain, nonatomic) TFNTwitterUser *businessUser; // @synthesize businessUser=_businessUser;
