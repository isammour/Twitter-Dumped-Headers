...
@class NSString, T1CompactMomentView, T1MomentCapsuleView, T1NativeMomentsCardViewModel, UILabel, UITapGestureRecognizer, UIView;
@protocol T1MomentCapsuleViewLayoutDelegate;

@interface T1NativeMomentsCardView : TFNTwitterCardView <T1MomentCapsuleViewDelegate, T1MomentCapsulePageImageViewDelegate>
{
