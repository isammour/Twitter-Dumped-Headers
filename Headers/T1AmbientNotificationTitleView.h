...
@class NSString, TFNTappableHighlightView, UIColor, UIImage, UIImageView, UILabel, UITapGestureRecognizer;

@interface T1AmbientNotificationTitleView : UIView <CAAnimationDelegate>
{
...
@property(readonly, nonatomic) UIView *rightSlidingTitleBackground; // @synthesize rightSlidingTitleBackground=_rightSlidingTitleBackground;
@property(readonly, nonatomic) UIView *leftSlidingTitleBackground; // @synthesize leftSlidingTitleBackground=_leftSlidingTitleBackground;
