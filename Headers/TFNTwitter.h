...
@class NSArray, NSDictionary, NSMutableDictionary, NSMutableSet, NSOrderedSet, NSRecursiveLock, NSString, TFNTwitterScribe, TFSStopwatch, TFSTwitterRecurringTaskTimerEventSource;
...
- (void)_accountSettingsModified:(id)arg1;
...
- (void)_logoutOauthSessionWithAccount:(id)arg1;
- (void)_removeAccount:(id)arg1 notifyAccountsDidChange:(_Bool)arg2;
- (void)removeTeamsAccount:(id)arg1;
- (_Bool)addOrUpdateTeamsAccount:(id)arg1;
- (id)addOrUpdateAccount:(id)arg1;
- (void)_addAccount:(id)arg1 addToSystemAccount:(_Bool)arg2 shouldNotifyAccountsDidChang:(_Bool)arg3;
...
- (id)_createActiveAccountUpdateActivityReadCursorRecurringTask:(id)arg1 context:(id)arg2;
