...
@class NSMutableArray, NSOperation, T1Canary, T1ImagePipelineService, T1MediaServicesResetScribe, T1PlayerNetworkUsageObserver, TFNTwitterDeviceTokenManager, TFNTwitterScribe;
...
- (void)_configureMediaPlayer;
- (void)_setupMediaPlayer;
- (void)_setupFrameRateReporterForAccount:(id)arg1;
- (void)_registerUserDefaults;
- (void)_tseui_updateShareSheetUIUpdateEnabled;
- (void)_updateShareSheetReimplementationEnabled:(id)arg1;
...
- (void)_configureAuthorizationManager:(id)arg1;
- (void)_configureGeoProvider;
...
- (void)_removeTFNDownloadCacheFromDisk;
