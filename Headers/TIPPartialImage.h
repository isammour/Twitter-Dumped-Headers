...
- (void).cxx_destruct;
- (id)renderImageWithMode:(long long)arg1 decoded:(_Bool)arg2;
- (void)_tip_extractState;
- (void)_tip_updateStateWithLatestResult:(long long)arg1;
- (long long)_tip_appendData:(id)arg1 final:(_Bool)arg2;
- (_Bool)_tip_detectCodec:(id)arg1 final:(_Bool)arg2;
