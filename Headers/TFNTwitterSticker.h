...
@interface TFNTwitterSticker : NSObject <NSCoding, NSCopying>
{
    NSString *_stickerID;
...
@property(readonly, nonatomic) id <TFNTwitterMultiResolutionImageSource> imageSource; // @synthesize imageSource=_imageSource;
