...
@class NSDictionary, NSNumber, NSString, TAVAnalyticsMediaIdentifier, TFNTwitterCardData, TFNTwitterMediaInfo, TFNTwitterPromotedContent, TFNTwitterStatus;
@protocol TFNTwitterCardDataSource, TFNTwitterCardDataSourceObject;

__attribute__((visibility("hidden")))
@interface _TtC9T1TwitterP33_B6155113CE23FAFE72FAFA561E8FFCF114CardDataSource : NSObject
{
    ...
    // Error parsing type: , name: isCardOfCanvasType
    // Error parsing type: , name: scribeParameters
    // Error parsing type: , name: mediaScribeContentID
    // Error parsing type: , name: autoPlayPublisherBlacklistID
    // Error parsing type: , name: allowDynamicAd
    // Error parsing type: , name: playerStatusID
    // Error parsing type: , name: playerStatus
    // Error parsing type: , name: promotedContentImpressionID
    // Error parsing type: , name: isEarned
}

- (CDUnknownBlockType).cxx_destruct;
- (id)init;
@property(nonatomic, readonly) _Bool isEarned; // @synthesize isEarned;
@property(nonatomic, readonly) NSString *promotedContentImpressionID; // @synthesize promotedContentImpressionID;
...
@property(nonatomic, readonly) NSNumber *autoPlayPublisherBlacklistID; // @synthesize autoPlayPublisherBlacklistID;
@property(nonatomic, readonly) TAVAnalyticsMediaIdentifier *contentMediaIdentifier;
@property(nonatomic, readonly) NSString *mediaScribeContentID; // @synthesize mediaScribeContentID;
@property(nonatomic, readonly) NSNumber *mediaScribePublisherID;
@property(nonatomic, readonly) NSDictionary *scribeParameters; // @synthesize scribeParameters;
@property(nonatomic, readonly) _Bool isCardOfCanvasType; // @synthesize isCardOfCanvasType;
@property(nonatomic, readonly) _Bool isVideoPoll; // @synthesize isVideoPoll;
...
@property(nonatomic, readonly) NSString *mediaPlaylistUrl; // @synthesize mediaPlaylistUrl;
...
@property(nonatomic, readonly) NSString *playerFactoryIdentifier;
...
@property(nonatomic, readonly) NSString *senderDisplayFullName; // @synthesize senderDisplayFullName;
@property(nonatomic, readonly) NSString *senderDisplayUsername; // @synthesize senderDisplayUsername;
...
@property(nonatomic, readonly) NSDictionary *cardEvent; // @synthesize cardEvent;
