...
@class NSArray, NSDictionary, NSString, TFNTwitterUser, TFNTwitterUserWhyToFollow;

@interface TFNTwitterUserRecommendation : NSObject <T1PeopleDiscoveryScribableItem, TFSTwitterScribableItem, TFSPlistSerialization, TFSTwitterTimelinePlistSerialization>
{
...
- (id)_initWithTimelinePlistDictionary:(id)arg1 forTimeline:(_Bool)arg2;
