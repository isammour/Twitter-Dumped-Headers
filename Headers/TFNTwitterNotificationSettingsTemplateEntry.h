...
@class NSString, TFNTwitterNotificationSettingsEntryControlTypeConfig, TFNTwitterNotificationSettingsEntryFeatureSwitchConfig;

@interface TFNTwitterNotificationSettingsTemplateEntry : NSObject
{
    ...
    TFNTwitterNotificationSettingsEntryControlTypeConfig *_controlTypeConfig;
    TFNTwitterNotificationSettingsEntryFeatureSwitchConfig *_featureSwitchConfig;
}
...
@property(readonly, nonatomic) TFNTwitterNotificationSettingsEntryFeatureSwitchConfig *featureSwitchConfig; // @synthesize featureSwitchConfig=_featureSwitchConfig;
@property(readonly, nonatomic) TFNTwitterNotificationSettingsEntryControlTypeConfig *controlTypeConfig; // @synthesize controlTypeConfig=_controlTypeConfig;
