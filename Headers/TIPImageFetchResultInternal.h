...
+ (id)resultWithImageContainer:(id)arg1 identifier:(id)arg2 source:(long long)arg3 URL:(id)arg4 originalDimensions:(struct CGSize)arg5 placeholder:(_Bool)arg6 transformed:(_Bool)arg7;
