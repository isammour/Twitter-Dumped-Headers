...
- (void)_tip_enqueueOperation:(id)arg1;
- (id)cacheOfType:(long long)arg1;
- (void)postCompletedEntry:(id)arg1 manual:(_Bool)arg2;
- (void)_tip_background_copyDiskCacheFileWithIdentifier:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
- (id)_tip_hydrateOperationWithRequest:(id)arg1;
