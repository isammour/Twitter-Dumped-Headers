...
@class TFNOnboardingMenuDialogSubtask;
@protocol T1OnboardingSubtaskControllerDelegate;

@interface T1OnboardingMenuDialogSubtaskController : T1OnboardingSubtaskController
{
    TFNOnboardingMenuDialogSubtask *_subtask;
