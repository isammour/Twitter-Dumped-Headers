...
@interface TFSTwitterAPIUsersLookUpCommand : TFSTwitterAPICommand
{
    NSArray *_userIDs;
...
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 accountModel:(id)arg3 userIDs:(id)arg4 source:(unsigned long long)arg5 completionBlock:(CDUnknownBlockType)arg6;
