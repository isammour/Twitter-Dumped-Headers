...
@interface TFNBooleanItemCollectionItemAdapter : TFNItemsCollectionItemAdapter
{
}
...
- (CDUnknownBlockType)actionForController:(id)arg1 item:(id)arg2 withOptions:(id)arg3;
