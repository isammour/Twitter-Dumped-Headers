...
@interface TFSTwitterAPIStratostorePuffsUserCommand : TFSTwitterAPICommand
{
    NSNumber *_userID;
}
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 userID:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
