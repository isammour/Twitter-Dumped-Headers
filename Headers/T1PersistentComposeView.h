...
@class NSString, T1ComposeRichTextView, T1TweetComposeSocialContextTextView, TFNButton, TFNButtonBarView, TFNPlaceholderTextView, UIFont, UITapGestureRecognizer;
...
@interface T1PersistentComposeView : UIView <T1TweetComposeSocialContextTextViewDelegate>
{
    ...
    _Bool _fullComposeButtonHidden;
...
@property(nonatomic, getter=isFullComposeButtonHidden) _Bool fullComposeButtonHidden; // @synthesize fullComposeButtonHidden=_fullComposeButtonHidden;
