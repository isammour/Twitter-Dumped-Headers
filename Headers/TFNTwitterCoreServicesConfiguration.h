...
@class NSNumber, NSSet, NSString, TFNTwitterAccessSettings;
...
@interface TFNTwitterCoreServicesConfiguration : NSObject <TFNTwitterCoreServicesConfiguration, NSCopying>
{
    ...
    _Bool _supportsAgeGating;
    _Bool _isScribeClientNetworkRequestEnabled;
    _Bool _isTwitterAccessEnabled;
...
@property(nonatomic) _Bool isTwitterAccessEnabled; // @synthesize isTwitterAccessEnabled=_isTwitterAccessEnabled;
@property(nonatomic) _Bool isScribeClientNetworkRequestEnabled; // @synthesize isScribeClientNetworkRequestEnabled=_isScribeClientNetworkRequestEnabled;
...
@property(retain, nonatomic) TFNTwitterAccessSettings *twitterAccessSettings; // @synthesize twitterAccessSettings=_twitterAccessSettings;
@property(nonatomic) _Bool supportsAgeGating; // @synthesize supportsAgeGating=_supportsAgeGating;
