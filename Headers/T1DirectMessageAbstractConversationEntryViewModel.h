...
@class NSString, T1DirectMessageConversationDisplayState, TFNLayoutMetrics, TFNTwitterAccount;
...
+ (id)_conversationEntryViewModelForMessageEntry:(id)arg1 displayState:(id)arg2;
+ (void)textByInsertingDirectionMarks:(inout id *)arg1 adjustingLinkRange:(inout id *)arg2;
+ (Class)cellClass;
+ (id)cellReuseIdentifier;
+ (id)_entryViewModelForDirectMessageEntry:(id)arg1 displayState:(id)arg2;
+ (id)entryViewModelForDirectMessageEntry:(id)arg1 displayState:(id)arg2;
