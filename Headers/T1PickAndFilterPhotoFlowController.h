...
@interface T1PickAndFilterPhotoFlowController : NSObject <TFNTwitterAuthenticated, T1FiltersViewControllerDelegate, T1PhotoGalleryViewControllerDelegate>
{
...
- (void)_t1_presentPhotoGalleryViewControllerInViewController:(id)arg1;
