...
@class NSDate, NSString, TFNDirectMessageConversation, TFNDirectMessageConversationEntry;

@interface TFNDirectMessageConversationRenamedEvent : NSObject <TFNDirectMessageEvent>
{
    long long _eventID;
    NSDate *_time;
    NSString *_requestID;
...
- (id)initWithEventID:(long long)arg1 time:(id)arg2 requestID:(id)arg3 conversation:(id)arg4 name:(id)arg5 entry:(id)arg6;
