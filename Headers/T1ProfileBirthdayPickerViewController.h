...
@interface T1ProfileBirthdayPickerViewController : TFNItemsDataViewController <T1ProfileBirthdayDisplayFormViewControllerDelegate, T1ProfileBirthdayValuePicker, TFNTwitterAuthenticated, TFNPickerViewControllerDelegate>
{
    ...
    TFNDataViewItem *_visibilitySelectDateItem;
    TFNDataViewItem *_visibilitySelectYearItem;
...
@property(retain, nonatomic) TFNDataViewItem *visibilitySelectYearItem; // @synthesize visibilitySelectYearItem=_visibilitySelectYearItem;
@property(retain, nonatomic) TFNDataViewItem *visibilitySelectDateItem; // @synthesize visibilitySelectDateItem=_visibilitySelectDateItem;
