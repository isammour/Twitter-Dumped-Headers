...
@interface T1TweetComposeSingleTweetViewController : TFNViewController <T1MediaAttachmentsViewControllerDelegate, T1ComposeTextViewDelegate, T1ComposePollingCardPreviewControllerDelegate, T1ComposeTagLocationViewControllerDelegate, T1TweetComposeLocatorDelegate, T1TaggingViewControllerDelegate, T1VideoMonetizationSettingsViewControllerDelegate, T1ComposeCardPreviewControllerDelegate, TFNTwitterCardViewDelegate, NSLayoutManagerDelegate, UIGestureRecognizerDelegate, TFNTwitterAuthenticated, TFNCharacterCountProgressDataSource>
{
...
- (void)_t1_presentModalViewController:(id)arg1 fromRect:(struct CGRect)arg2 inView:(id)arg3 preferredHeightForPresentation:(double)arg4;
...
- (double)scaleFactorForInputLanguage;
