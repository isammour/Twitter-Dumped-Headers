...
@class NSString, T1EditProfileBlurrableBannerImageView, T1EditProfileForm, T1MediaChooser, T1PickAndFilterPhotoFlowController, T1ProfileAvatarImageView, TFNFormAppearance, TFNTwitterAccount, UIBarButtonItem, UIImageView;
@protocol T1EditProfileViewControllerDelegate;

@interface T1EditProfileViewController : TFNFormViewController <TFNLayoutMetricsEnvironment, T1MediaChooserDelegate, T1PickAndFilterPhotoFlowControllerDelegate, TFNTwitterAuthenticated, T1JumpBackToHomeTimelineBehavior>
{
...
- (void)_closeAction;
- (void)_t1_showProfilePhotoPrompt;
- (void)proceedAfterSaving;
- (void)save;
- (void)closeAndShowProfilePhotoPrompt:(_Bool)arg1;
