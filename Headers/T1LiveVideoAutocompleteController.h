...
@protocol T1LiveVideoAutocompleteControllerDelegate;

@interface T1LiveVideoAutocompleteController : NSObject
{
    _Bool _isAutocompleteVisible;
    id <T1LiveVideoAutocompleteControllerDelegate> _delegate;
...
@property(nonatomic) __weak id <T1LiveVideoAutocompleteControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
