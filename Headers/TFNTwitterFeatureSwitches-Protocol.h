...
@class NSArray, NSDictionary, NSNumber, NSString, TFNTwitterAccount;
...
- (void)partiallyApplyPendingWithAccount:(TFNTwitterAccount *)arg1 keys:(NSArray *)arg2;
- (void)applyPendingWithAccount:(TFNTwitterAccount *)arg1;
- (void)forceRefreshDeviceFeatureSwitchesWithCompletion:(void (^)(_Bool))arg1;
- (void)forceRefreshWithAccount:(TFNTwitterAccount *)arg1 completion:(void (^)(_Bool))arg2;
- (void)refreshDeviceFeatureSwitchesIfNecessaryWithCompletion:(void (^)(_Bool))arg1;
- (void)refreshIfNecessaryWithAccount:(TFNTwitterAccount *)arg1 completion:(void (^)(_Bool))arg2;
- (void)refreshWithAccount:(TFNTwitterAccount *)arg1 maxStale:(double)arg2 timeout:(double)arg3 completion:(void (^)(_Bool))arg4;
- (void)refreshWithAccount:(TFNTwitterAccount *)arg1 maxStale:(double)arg2 completion:(void (^)(_Bool))arg3;
