...
- (struct CGPath *)pathWithRect:(struct CGRect)arg1 roundedRectCorners:(unsigned long long)arg2 cornerRadius:(double)arg3 transform:(const struct CGAffineTransform *)arg4;
- (void)layoutSubviews;
