...
- (void).cxx_destruct;
- (void)executeClientBlock:(CDUnknownBlockType)arg1;
- (id)initWithRequest:(id)arg1 cachedResponse:(id)arg2 client:(id)arg3;
- (void)stopLoading;
- (void)chunkData:(id)arg1 bps:(unsigned long long)arg2 bytesSent:(unsigned long long)arg3 latency:(double)arg4;
- (void)startLoading;
