...
@interface TFSTwitterAPIMutesKeywordsDiscouragedListCommand : TFSTwitterAPICommand
{
}

- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
