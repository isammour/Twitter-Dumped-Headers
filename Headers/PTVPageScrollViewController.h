...
#import <PeriscopeViewer/PTVPageScrollViewDataSource-Protocol.h>
...
- (void)updateCurrentViewController:(id)arg1 precedingViewController:(id)arg2 followingViewController:(id)arg3;
