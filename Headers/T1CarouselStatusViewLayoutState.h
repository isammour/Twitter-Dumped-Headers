...
@class NSString, TFNLayoutMetrics, TFNTwitterAccount, TFNTwitterCardViewLayoutState;
...
@property(retain, nonatomic) TFNTwitterCardViewLayoutState *cardLayoutState; // @synthesize cardLayoutState=_cardLayoutState;
