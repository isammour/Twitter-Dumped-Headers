...
@class NSString, T1CustomerFeedbackRatingViewsContainerView, T1NativeCustomerFeedbackCardViewModel, TFNButton, TFNHTMLTextView, UIButton, UILabel, UIView;

@interface T1NativeCustomerFeedbackCardView : TFNTwitterCardView <TFNHTMLTextViewDelegate, T1CustomerFeedbackRatingViewDelegate>
{
...
@property(retain, nonatomic) T1NativeCustomerFeedbackCardViewModel *viewModel; // @synthesize viewModel=_viewModel;
- (void).cxx_destruct;
