...
@interface T1NativeLiveVideoCardRefreshEndpoint : NSObject
{
    NSString *_capiURL;
    NSString *_cardURI;
    NSString *_cardName;
    NSString *_liveVideoEventID;
}

@property(copy, nonatomic) NSString *liveVideoEventID; // @synthesize liveVideoEventID=_liveVideoEventID;
