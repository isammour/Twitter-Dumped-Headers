...
#import <TFNUI/TFNButtonAppearanceDelegate-Protocol.h>
#import <TFNUI/TFNHapticFeedback-Protocol.h>

@class NSAttributedString, NSString, TFNButtonAppearance, TFNButtonAppearanceImpl, TFNButtonAppearanceKey, UIColor, UIImage, UIImageView, UIImpactFeedbackGenerator, UILabel, UINotificationFeedbackGenerator, UISelectionFeedbackGenerator;
@protocol TFNButtonAnimationCoordinator, TFNButtonImageProvider;

@interface TFNButton : UIButton <TFNButtonAppearanceDelegate, TFNHapticFeedback>
{
    ...
    id <TFNButtonAnimationCoordinator> _animationCoordinator;
...
@property(nonatomic) __weak id <TFNButtonImageProvider> imageProvider;
...
@property(readonly, nonatomic) TFNButtonAppearance *appearance;
