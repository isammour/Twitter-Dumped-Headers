...
@class TFNLayoutMetricsComputation, UIFont, UITraitCollection;
...
@property(readonly, nonatomic) long long numberOfBodyColumns;
...
@property(readonly, nonatomic) double barItemInset;
