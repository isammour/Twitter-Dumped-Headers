...
@class TFNTwitterScribeBackgroundTaskManager, TFNTwitterScribeErrorHandler, TFNTwitterScribeLifecycleObserver, TFNTwitterScribeWriter, TFSScribe;

@interface TFNTwitterScribeSystem : NSObject
{
    // Error parsing type: {?="mutex"{_opaque_pthread_mutex_t="__sig"q"__opaque"[56c]}"predicate"{atomic_flag="_Value"AB}}, name: _memberTransientDispatchOnceToken
    // Error parsing type: {?="mutex"{_opaque_pthread_mutex_t="__sig"q"__opaque"[56c]}"predicate"{atomic_flag="_Value"AB}}, name: _scribeWriterMemberTransientDispatchOnceToken
