...
@class NSArray, NSMapTable, NSMutableArray, NSString, T1TweetComposeReplyContextViewController, T1TweetComposeSingleTweetViewController, T1TweetComposeTableView, TFNTwitterAccount, TFSMainThreadRunLoopDeferredTask, UILongPressGestureRecognizer, UITapGestureRecognizer;
@protocol T1TweetComposeTableViewControllerDelegate;

@interface T1TweetComposeTableViewController : UIViewController <T1TweetComposeSingleTweetViewControllerDelegate, T1TweetComposeReplyContextViewControllerDelegate, UITableViewDelegate, UITableViewDataSource, TFNTwitterAuthenticated>
{
    ...
    T1TweetComposeReplyContextViewController *_replyContextVC;
...
@property(retain, nonatomic) T1TweetComposeReplyContextViewController *replyContextVC; // @synthesize replyContextVC=_replyContextVC;
...
- (void)updateFrameForReplyContextViewController:(id)arg1 withPreferredHeight:(double)arg2;
- (double)widthForReplyContextViewController:(id)arg1;
...
- (struct CGPoint)_t1_originForReplyContextWithHeight:(double)arg1;
