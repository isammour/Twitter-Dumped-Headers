...
@interface TFNTwitterMediaAssetPackedSegmentedUploadScribeOperation : TFSDependentConcurrentOperation <TFNTwitterMediaAssetPackedSegmentedUploadScribeValueDependency>
{
...
- (id)_tfn_main_scribeElement;
- (id)_tfn_main_scribeAction;
- (void)_tfn_main_run;
- (void)run;
