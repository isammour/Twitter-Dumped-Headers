...
@interface T1DirectMessageComposeTextView : TFNRoundedTextView <TFNTwitterCardViewDelegate>
{
...
@property(nonatomic) _Bool copyLocally; // @synthesize copyLocally=_copyLocally;
