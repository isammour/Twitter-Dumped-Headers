...
@interface TFNPreviewingModalViewController : UIViewController <TFNModalContainerViewController>
{
    ...
    NSArray *_overridePreviewActionItems;
...
@property(retain, nonatomic) NSArray *overridePreviewActionItems; // @synthesize overridePreviewActionItems=_overridePreviewActionItems;
