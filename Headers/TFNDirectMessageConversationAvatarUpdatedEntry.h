...
@class NSDate, NSDictionary, NSString, TFNDirectMessageConversationEntryIdentifier, TFNTwitterEntityImageInfo;
@protocol TFNDirectMessageContext, TFNDirectMessageConversation, TFNDirectMessageUser;

@interface TFNDirectMessageConversationAvatarUpdatedEntry : TFNDirectMessageConversationEntry
{
    TFNTwitterEntityImageInfo *_avatarInfo;
    id <TFNDirectMessageUser> _author;
}

@property(readonly, nonatomic) id <TFNDirectMessageUser> author; // @synthesize author=_author;
