...
@class NSArray, NSError, NSString, TFNModalSheetViewController, TFNPageSheetModalViewController, TFNTwitterAccount, UIImage, UINavigationController, UIView, UIViewController;
