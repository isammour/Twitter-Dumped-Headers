...
#import <TFNUI/TFNScopeBarDelegate-Protocol.h>
...
@interface TFNNavigationController : UINavigationController <TFNKeyboardShortcutDelegate, TFNScopeBarDelegate, UINavigationControllerDelegate, UIGestureRecognizerDelegate, TFNLayoutMetricsEnvironment>
{
    ...
    struct {
        ...
        unsigned int savedScopeBarTranslucency:1;
    } _state;
...
- (void)_tfn_updateScopeBar;
- (_Bool)_tfn_useScopeBarForViewController:(id)arg1;
- (id)_tfn_currentScopeBar;
...
- (_Bool)_tfn_shouldDisplayToolbar;
- (void)_tfn_updateToolbarItemsForViewController:(id)arg1;
- (void)_tfn_updateBarButtonItemsDisplayMode;
- (void)_tfn_navigationItemDidUpdateBarButtonItems;
...
- (id)_tfn_viewControllerOrChildPresentingFrom:(id)arg1;
...
- (void)_tfn_willAddViewController:(id)arg1;
- (void)_tfn_undoPrepareOutgoingViewController;
- (void)_tfn_prepareOutgoingViewController;
- (void)pushViewController:(id)arg1 animated:(_Bool)arg2;
- (void)setViewControllers:(id)arg1 animated:(_Bool)arg2;
- (void)_tfn_temporarilyDisableLeftBarButtonItemOnRootViewControllerIfRequired;
@property(readonly, nonatomic) _Bool leftBarButtonItemTemporaryDelayEnabled;
- (void)backButtonLongPressAction:(id)arg1;
- (void)titleTapAction:(id)arg1;
- (_Bool)scrollToTopAnimated:(_Bool)arg1 flashScrollIndicators:(_Bool)arg2;
...
- (id)init;
- (void)childViewController:(id)arg1 didEndEditingAnimated:(_Bool)arg2;
- (void)childViewController:(id)arg1 didStartEditingAnimated:(_Bool)arg2;
