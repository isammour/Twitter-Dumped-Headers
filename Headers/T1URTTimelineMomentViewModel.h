...
@class NSDate, NSDictionary, NSString, TFNTwitterMoment, TFNTwitterMomentAccess, TFNTwitterMomentAuthor, TFNTwitterMomentCapsuleCTA, TFNTwitterMomentCurationMetadata, TFNTwitterMomentEvent, TFNTwitterMomentPage, TFNTwitterMomentPremadeMomentData, TFNTwitterPromotedContent, TFNTwitterUser;

@interface T1URTTimelineMomentViewModel : NSObject
{
...
@property(nonatomic, readonly) _Bool isSuperhero;
@property(nonatomic, retain) TFNTwitterMoment *moment; // @synthesize moment;
