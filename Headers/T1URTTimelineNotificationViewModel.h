...
@class NSDictionary, NSString, T1URTDismissFeedbackContext, T1URTURLViewModel;
...
@property(nonatomic, readonly) T1URTDismissFeedbackContext *feedbackContext; // @synthesize feedbackContext;
