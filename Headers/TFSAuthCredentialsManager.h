...
@class NSString, TFSAuthAppOAuth2Helper, TFSAuthConfiguration, TFSAuthConsumerCredential, TFSAuthGuestAuthManager, TFSAuthOAuth1Helper, TFSAuthReverseAuthManager;
...
@property(readonly, nonatomic) TFSAuthReverseAuthManager *reverseAuthManager; // @synthesize reverseAuthManager=_reverseAuthManager;
...
- (void)_signAccountRequestUsingSystemAccount:(id)arg1 parameters:(id)arg2 multipart:(_Bool)arg3 accountID:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_signAccountRequest:(id)arg1 parameters:(id)arg2 multipart:(_Bool)arg3 accountID:(id)arg4 requestingAppCredential:(id)arg5 completion:(CDUnknownBlockType)arg6;
...
- (void)signRequest:(id)arg1 parameters:(id)arg2 multipart:(_Bool)arg3 accountID:(id)arg4 authContext:(id)arg5 completion:(CDUnknownBlockType)arg6;
