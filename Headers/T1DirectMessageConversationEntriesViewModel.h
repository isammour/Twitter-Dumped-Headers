...
+ (id)_mutableEntryViewModelsForEntries:(id)arg1 displayState:(id)arg2;
+ (double)flowLayoutMinimumLineSpacing;
+ (id)conversationViewModelWithConversation:(id)arg1 entries:(id)arg2 layoutMetrics:(id)arg3 account:(id)arg4;
...
- (id)initWithEntryViewModels:(id)arg1 displayState:(id)arg2;
