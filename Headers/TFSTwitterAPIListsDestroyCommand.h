...
@interface TFSTwitterAPIListsDestroyCommand : TFSTwitterAPICommand
{
    NSNumber *_listID;
}
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 listID:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
