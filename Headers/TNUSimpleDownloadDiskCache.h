...
- (void).cxx_destruct;
- (void)diskCache_populateEntries:(id)arg1 falseEntryPaths:(id)arg2 totalSize:(unsigned long long *)arg3 fromEntryPaths:(id)arg4;
- (void)diskCache_sortEntries:(id)arg1;
- (void)diskCache_loadDiskCacheManifest;
- (_Bool)diskCache_storeToDiskCache:(id)arg1 response:(id)arg2 fileURL:(id *)arg3 error:(id *)arg4;
