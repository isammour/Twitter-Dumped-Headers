...
@protocol TFNDirectMessageCardAttachment, TFNDirectMessageEntry, TFNDirectMessageMediaAttachment, TFNDirectMessageStickerAttachment, TFNDirectMessageTweetAttachment;
...
@interface T1DirectMessageEntryMetricsComputationParameters : NSObject
{
    ...
    id <TFNDirectMessageStickerAttachment> _stickerAttachment;
...
@property(readonly, nonatomic) id <TFNDirectMessageStickerAttachment> stickerAttachment; // @synthesize stickerAttachment=_stickerAttachment;
...
- (void).cxx_destruct;
- (id)initWithMessageEntry:(id)arg1 textModel:(id)arg2 interstitialTextModel:(id)arg3 seenByParticipantNamesTextModel:(id)arg4 mediaAttachment:(id)arg5 tweetAttachment:(id)arg6 stickerAttachment:(id)arg7 cardAttachment:(id)arg8 textSize:(struct CGSize)arg9 outgoing:(_Bool)arg10 lastInGroup:(_Bool)arg11 shouldRenderCard:(_Bool)arg12 shouldRenderInterstitial:(_Bool)arg13 ctasCount:(long long)arg14 maxContentWidth:(double)arg15 maxTextWidth:(double)arg16 layoutMetrics:(id)arg17 account:(id)arg18;
