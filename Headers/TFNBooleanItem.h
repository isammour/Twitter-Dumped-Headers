...
@class NSDictionary, NSString, TFNButton, TFNDataViewController, UISwitch;
...
- (void)private_setupButton;
- (id)private_buttonForDataViewController:(id)arg1 options:(id)arg2;
- (void)private_switchAction:(id)arg1;
- (id)private_switchForDataViewController:(id)arg1 options:(id)arg2;
- (void)setUpWithCollectionViewCell:(id)arg1;
...
- (id)initWithButton:(id)arg1 text:(id)arg2 value:(_Bool)arg3 updateTarget:(id)arg4 action:(SEL)arg5;
- (id)initWithButton:(id)arg1 text:(id)arg2 value:(_Bool)arg3 updateAction:(CDUnknownBlockType)arg4;
