...
- (id)init;
- (id)initWithLevel:(unsigned long long)arg1 file:(id)arg2 function:(id)arg3 line:(long long)arg4 channel:(id)arg5 timestamp:(id)arg6 logLifespan:(double)arg7 threadId:(unsigned int)arg8 threadName:(id)arg9 contextObject:(id)arg10 message:(id)arg11;
