...
@class NSDictionary, NSString, TFNTwitterCardData, TFNTwitterPromotedContent, TFSTwitterEntityURL;
@protocol TFNDirectMessageContext, TFNDirectMessageEntry, TFNTwitterCardDataSourceObject;
