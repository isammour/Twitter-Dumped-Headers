...
#import <TFSTwitterCore/TFSTwitterUserExtendedProfileBirthday.h>

#import <T1Twitter/TFNPickableValue-Protocol.h>

@class NSString, UIImage;

@interface TFSTwitterUserExtendedProfileBirthday (TFSTwitterUserExtendedProfileBirthday_TFNPickableValue) <TFNPickableValue>
