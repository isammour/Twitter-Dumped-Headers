...
@class DirectMessageEntryInterstitialSource, NSArray, NSAttributedString, NSString, T1DirectMessageEntryMetrics, T1DirectMessageEntryViewModelVariant, T1DirectMessageUser, TFNAttributedTextModel, TFNLayoutMetrics, TFNTwitterCardContext, TFNTwitterStatus, TFSFlavoredRange, UIFont;
@protocol TFNDirectMessageEntry, TFNDirectMessageMediaAttachment, TFNDirectMessageStickerAttachment;
...
@interface T1DirectMessageEntryViewModel : T1DirectMessageAbstractConversationEntryViewModel
{
    ...
    T1DirectMessageUser *_senderViewModel;
    ...
    TFNAttributedTextModel *_stickerUnavailableViewAttributedTextModel;
...
@property(retain, nonatomic) TFNAttributedTextModel *stickerUnavailableViewAttributedTextModel; // @synthesize stickerUnavailableViewAttributedTextModel=_stickerUnavailableViewAttributedTextModel;
...
@property(readonly, nonatomic) T1DirectMessageUser *senderViewModel; // @synthesize senderViewModel=_senderViewModel;
