...
@class NSDate, NSString, TFNDirectMessageConversation, TFNDirectMessageConversationEntry, TFNTwitterEntityImageInfo;

@interface TFNDirectMessageConversationAvatarUpdatedEvent : NSObject <TFNDirectMessageEvent>
{
    long long _eventID;
    NSDate *_time;
    NSString *_requestID;
...
- (id)initWithEventID:(long long)arg1 time:(id)arg2 requestID:(id)arg3 conversation:(id)arg4 avatarInfo:(id)arg5 entry:(id)arg6;
