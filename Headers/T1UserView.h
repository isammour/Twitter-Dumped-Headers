...
@class NSString, T1AffiliateBadgeView, T1DismissButton, T1InfoTextView, T1TimelinesItemSocialContextView, T1UserBadger, TFNAttributedTextView, TFNFollowsYouView, TFNSizeThatFitsHelper, TFNTappableHighlightView, TFNTwitterAccount, TFNTwitterAvatarImageView, TFNTwitterBannerImageView, TFSTwitterScribeContext, UIFont, UIImageView, UILabel, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
@interface T1UserView : UIView <TFNTwitterFollowControlDelegate, UIGestureRecognizerDelegate, T1TimelinesItemSocialContextViewDelegate, TFNLayoutMetricsEnvironment, TFNTwitterAuthenticated>
{
    ...
    TFNFollowsYouView *_followsYouView;
...
@property(readonly, nonatomic) TFNTwitterBannerImageView *bannerImageView; // @synthesize bannerImageView=_bannerImageView;
...
@property(readonly, nonatomic) TFNFollowsYouView *followsYouView; // @synthesize followsYouView=_followsYouView;
...
@property(readonly, nonatomic) TFNTwitterAvatarImageView *avatarView; // @synthesize avatarView=_avatarView;
...
- (_Bool)_currentUserColorSchemeIsLightOnDark;
