...
@class NSDate, NSDictionary, NSNumber, NSString, TFNDirectMessageConversationEntryIdentifier;
...
@interface TFNDirectMessageCustomerFeedbackSubmittedEntry : TFNDirectMessageConversationEntry <TFNDirectMessageCustomerFeedbackSubmittedEntry>
{
    ...
    NSNumber *_score;
    id <TFNDirectMessageUser> _surveySender;
}

@property(readonly, nonatomic) id <TFNDirectMessageUser> surveySender; // @synthesize surveySender=_surveySender;
