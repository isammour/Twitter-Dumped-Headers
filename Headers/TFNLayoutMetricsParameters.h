...
- (void)tfx_wideLayoutTrailingContentAreaBodyWidthPercentParameterChanged;
- (void)tfx_wideLayoutLeadingContentAreaBodyWidthPercentParameterChanged;
...
@property(readonly, nonatomic) double bodyColumnSpacingEms;
@property(readonly, nonatomic) unsigned long long bodyColumnCount;
@property(readonly, nonatomic) double wideLayoutTrailingContentAreaBodyWidthPercent;
@property(readonly, nonatomic) double wideLayoutLeadingContentAreaBodyWidthPercent;
