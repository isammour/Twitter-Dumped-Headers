...
@class NSArray, NSMutableSet, NSString, T1AccountListEntry, T1AccountsViewControllerKeepAliveCallbacks, T1AppBadging, T1OnboardingFlowAssistant, T1PickableAccountEntryAdapter, TFNTwitterAccount;

@interface T1AccountsViewController : TFNPickerViewController <TFNPickerViewControllerDelegate, TFNValuePickerDataSource, TFNLayoutMetricsEnvironment, T1AccountListEntryBadgingDataSource, T1AccountAdder, T1AccountChooser>
{
    T1OnboardingFlowAssistant *_onboardingFlowAssistant;
    _Bool _editing;
    _Bool _compactStyle;
...
@property(readonly, nonatomic) T1AppBadging *appBadging; // @synthesize appBadging=_appBadging;
...
- (void)viewDidLoad;
- (id)initAsEditable:(_Bool)arg1 includeTeamsAccount:(_Bool)arg2;
- (id)initAsEditable:(_Bool)arg1;
