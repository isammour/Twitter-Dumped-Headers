...
@class NSString, NSURL, T1MomentCapsuleStatusInfoForegroundView, TFNTwitterCardView, TFNTwitterCardViewEvent, TFNTwitterMomentCapsule, TFNTwitterStatus, TFSTwitterUserReference, UIView;
...
- (void)statusInfoForegroundView:(T1MomentCapsuleStatusInfoForegroundView *)arg1 cardView:(TFNTwitterCardView *)arg2 didFireViewEvent:(TFNTwitterCardViewEvent *)arg3;
