...
@class NSSet, NSString, T1KeywordForm, TFNAutocompleteViewController, TFNDoneBarButtonItem, TFNStringDataViewAdapter, TFNTwitterAccount, TFNTwitterMutedKeyword, TFSTwitterScribeContext;
@protocol T1MuteKeywordFormViewControllerDelegate;

@interface T1MuteKeywordFormViewController : TFNFormViewController <TFNFormDelegate, TNLCommunicationAgentObserver, T1MuteKeywordDurationViewControllerDelegate>
{
    ...
    TFNTwitterMutedKeyword *_keyword;
}

+ (id)textForDuration:(double)arg1;
+ (id)textForDate:(id)arg1;
+ (double)timeIntervalForDate:(id)arg1;
@property(retain, nonatomic) TFNTwitterMutedKeyword *keyword; // @synthesize keyword=_keyword;
...
- (long long)autocompleteSourceType;
- (void)submitForm;
- (id)layout;
...
- (id)initWithAccount:(id)arg1 delegate:(id)arg2 keywordString:(id)arg3 scribeContext:(id)arg4;
- (id)initWithAccount:(id)arg1 delegate:(id)arg2 keyword:(id)arg3 scribeContext:(id)arg4;
