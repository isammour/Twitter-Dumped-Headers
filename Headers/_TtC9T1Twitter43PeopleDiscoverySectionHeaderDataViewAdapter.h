...
@interface _TtC9T1Twitter43PeopleDiscoverySectionHeaderDataViewAdapter : TFNItemsDataViewAdapter
{
    // Error parsing type: , name: attributedTextForMockDisclosureIndicator.storage
}
