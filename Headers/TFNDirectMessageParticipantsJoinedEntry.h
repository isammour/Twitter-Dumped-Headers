...
@interface TFNDirectMessageParticipantsJoinedEntry : TFNDirectMessageConversationEntry
{
    NSArray *_participants;
    id <TFNDirectMessageUser> _addedBy;
}

@property(readonly, nonatomic) id <TFNDirectMessageUser> addedBy; // @synthesize addedBy=_addedBy;
...
- (id)initWithIdentifier:(id)arg1 participants:(id)arg2 addedBy:(id)arg3 time:(id)arg4;
