...
@class NSMutableArray, NSMutableSet, NSString, T1AccordionButton, T1ComposePollingCardPreviewView, T1MediaChooser, TFNButton, TFNPaddedButton, TFNTwitterAccount, TFNTwitterCompositionPollingCard, UITextField;
@protocol T1ComposePollingCardPreviewControllerDelegate;

@interface T1ComposePollingCardPreviewController : TFNViewController <UITextFieldDelegate, T1DurationPickerViewDelegate, T1MediaChooserDelegate, TFNTwitterAuthenticated>
{
