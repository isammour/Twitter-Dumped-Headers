...
@interface TFSTwitterAPIDeviceFollowingIDsCommand : TFSTwitterAPICommand
{
    NSString *_cursor;
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 cursor:(id)arg3 requestType:(unsigned long long)arg4 source:(unsigned long long)arg5 completionBlock:(CDUnknownBlockType)arg6;
