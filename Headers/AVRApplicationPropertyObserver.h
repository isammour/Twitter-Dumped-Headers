...
@interface AVRApplicationPropertyObserver : NSObject
{
...
- (void).cxx_destruct;
- (void)_avr_orientationDidChange;
- (void)_avr_applicationStateDidChange;
- (void)_avr_applicationStateChanged:(id)arg1;
