...
@class NSArray, NSMapTable, NSString, T1AppNavigationContext, T1ProfileDisplayContentProvider, T1ProfileDisplayNormalSubheaderContentProvider, T1ProfileHeaderViewController, T1ProfileSpriteAnimationBehavior, TFNFloatingActionButtonItem, TFNTwitterStatus, TFSStopwatch, TFSTimer, TFSTwitterScribeContext;
@protocol T1ProfileDataSource;

@interface T1ProfileViewController : T1ResizableHeaderContainerViewController <T1ProfileDisplayContentProviderDelegate, TFNPresentationInterceptor, T1ResizableHeaderContentDelegate, T1ResizableHeaderViewControllerDelegate, T1ProfileHeaderViewControllerDelegate, T1EditableProfileViewController, TFNNavigationControllerTransitionProvider, T1SpotlightUserActivityInfoProvider>
{
