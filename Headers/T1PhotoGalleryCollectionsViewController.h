...
@interface T1PhotoGalleryCollectionsViewController : TFNViewController <UITableViewDataSource, UITableViewDelegate, TFNPageSheetModalViewControllerDelegate, TFNModalSheetViewControllerDelegate, PHPhotoLibraryChangeObserver, TFNTwitterAuthenticated>
{
    _Bool _dismissing;
    ...
    NSArray *_additionalCollectionNames;
...
@property(copy, nonatomic) NSArray *additionalCollectionNames; // @synthesize additionalCollectionNames=_additionalCollectionNames;
...
- (id)_collectionNameForIndexPath:(id)arg1;
