...
@class NSString, TFNOnboardingInterestPickerSubtask, TFNOnboardingInterestPickerSubtaskState;
...
{
    TFNOnboardingInterestPickerSubtask *_subtask;
    TFNOnboardingInterestPickerSubtaskState *_state;
