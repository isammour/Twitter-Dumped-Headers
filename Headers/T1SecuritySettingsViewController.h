...
@interface T1SecuritySettingsViewController : TFNItemsDataViewController <T1SettingsAuthorizationInstructionsAdapterDelegate, T1AddPhoneNumberDelegate, T1SettingsAccountInitializable>
{
    _Bool _isSMS2faEnabled;
    _Bool _is2FA3Enabled;
    _Bool _is2FA3U2fEnabled;
...
@property(nonatomic) __weak id <T1SecuritySettingsViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)_t1_new_updateSections;
- (void)_t1_legacy_updateSections;
- (_Bool)_t1_shouldUseLegacyUI;
