...
+ (void)initialize;
+ (id)queuedTimerOnQueue:(id)arg1 withTimeInterval:(double)arg2 block:(CDUnknownBlockType)arg3 repeats:(_Bool)arg4 backgroundingBehavior:(long long)arg5;
+ (id)queuedTimerOnQueue:(id)arg1 withTimeInterval:(double)arg2 block:(CDUnknownBlockType)arg3 repeats:(_Bool)arg4;
...
+ (id)scheduledTimerWithTimeInterval:(double)arg1 block:(CDUnknownBlockType)arg2 repeats:(_Bool)arg3 backgroundingBehavior:(long long)arg4;
...
+ (id)timerWithTimeInterval:(double)arg1 block:(CDUnknownBlockType)arg2 repeats:(_Bool)arg3 backgroundingBehavior:(long long)arg4;
...
- (id)initWithFireDate:(id)arg1 interval:(double)arg2 block:(CDUnknownBlockType)arg3 repeats:(_Bool)arg4 backgroundingBehavior:(long long)arg5;
...
- (id)initWithFireDate:(id)arg1 interval:(double)arg2 target:(id)arg3 selector:(SEL)arg4 userInfo:(id)arg5 block:(CDUnknownBlockType)arg6 repeats:(_Bool)arg7 backgroundingBehavior:(long long)arg8;
- (id)init;
- (void)dealloc;
