...
@property(readonly, nonatomic) long long graphemeClusterMaxDiscount; // @synthesize graphemeClusterMaxDiscount=_graphemeClusterMaxDiscount;
@property(readonly, nonatomic, getter=isGraphemeClusterParsingEnabled) _Bool graphemeClusterParsingEnabled; // @synthesize graphemeClusterParsingEnabled=_graphemeClusterParsingEnabled;
