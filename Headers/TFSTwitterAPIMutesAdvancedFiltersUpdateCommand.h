...
@interface TFSTwitterAPIMutesAdvancedFiltersUpdateCommand : TFSTwitterAPICommand
{
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 advancedFilters:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
