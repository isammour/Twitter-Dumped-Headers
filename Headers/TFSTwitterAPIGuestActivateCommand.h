...
@interface TFSTwitterAPIGuestActivateCommand : TFSTwitterAPICommand
{
}

- (id)request;
- (id)initWithService:(id)arg1 bearerToken:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
