...
@class NSArray, NSString, T1ComposeCardPreviewView, T1NativeCardConsistencyChecker, TFNPaddedButton, TFNTwitterAccount, TFNTwitterCardData, TFNTwitterCardView, TFSTimer;
...
@property(retain, nonatomic) T1NativeCardConsistencyChecker *cardConsistencyChecker; // @synthesize cardConsistencyChecker=_cardConsistencyChecker;
