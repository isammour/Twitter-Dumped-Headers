...
#import <T1Twitter/TFNCanvasInnerViewControllerDelegate-Protocol.h>
...
@class NSMutableDictionary, NSString, TFNCanvasBackgroundView, TFNCanvasTweetBar, UIPanGestureRecognizer, UIView, UIViewController;
@protocol TFNCanvasControllableElementView, TFNCanvasEventHandler, TFNCanvasEventHandlerDelegate, TFNCanvasInnerViewControllerProtocol;
...
@interface TFNCanvasViewController : TFNViewController <UIGestureRecognizerDelegate, UIViewControllerTransitioningDelegate, TFNCanvasEventHandlerDelegate, TFNCanvasInnerViewControllerDelegate, TFNPresented>
{
    ...
    TFNViewController<TFNCanvasInnerViewControllerProtocol> *_innerViewController;
...
@property(readonly, nonatomic) TFNCanvasTweetBar *tweetBar; // @synthesize tweetBar=_tweetBar;
@property(retain, nonatomic) TFNViewController<TFNCanvasInnerViewControllerProtocol> *innerViewController; // @synthesize innerViewController=_innerViewController;
