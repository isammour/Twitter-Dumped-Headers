...
@class NSString, TFNButton, TFNHUD, TFNTwitterAccount, UIActivityIndicatorView, UIImageView;

@interface T1NotificationsAnniversaryViewController : TFNItemsDataViewController <TFNTwitterImageViewFetchHelperDelegate>
{
...
- (id)init;
- (id)initWithAccount:(id)arg1 message:(id)arg2 imageURLString:(id)arg3 imageDimensions:(struct CGSize)arg4 actionText:(id)arg5 tweetText:(id)arg6 tweetCursor:(struct _NSRange)arg7;
