...
- (void)accessedCGContext:(_Bool)arg1 duration:(double)arg2;
...
- (id)initInternal;
- (void)_tip_inspectRemainingPipelines:(id)arg1 gatheredResults:(id)arg2 callback:(CDUnknownBlockType)arg3;
