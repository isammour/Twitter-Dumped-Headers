...
@class NSDate, NSString, TFNTwitterTrendsLocation;

@interface TFNTwitterSettings : NSObject
{
    _Bool _geoEnabled;
    ...
    unsigned long long _rankedTimeline;
    unsigned long long _dmLowQualityFilterSetting;
    unsigned long long _mentionFilterSetting;
    TFNTwitterTrendsLocation *_trendsLocation;
}

+ (_Bool)isRankedTimelineOnFromOptions:(unsigned long long)arg1;
+ (id)settingsWithJSONData:(id)arg1 error:(id *)arg2;
@property(retain, nonatomic) TFNTwitterTrendsLocation *trendsLocation; // @synthesize trendsLocation=_trendsLocation;
...
@property(nonatomic) _Bool rankedTimelineEnabled; // @synthesize rankedTimelineEnabled=_rankedTimelineEnabled;
...
@property(nonatomic) unsigned long long rankedTimeline; // @synthesize rankedTimeline=_rankedTimeline;
