...
#import <T1Twitter/TFNTwitterCardContext.h>

@class T1MomentCapsuleViewConfiguration;

__attribute__((visibility("hidden")))
@interface _TtC9T1Twitter30StandardTrendMomentCardContext : TFNTwitterCardContext
{
}
