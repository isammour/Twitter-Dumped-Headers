...
- (id)initWithType:(long long)arg1 boundingDimensions:(struct CGSize)arg2 name:(id)arg3 formats:(id)arg4;
- (id)initWithType:(long long)arg1 boundingDimensions:(struct CGSize)arg2 name:(id)arg3 formats:(id)arg4 requestURLFormat:(long long)arg5;
