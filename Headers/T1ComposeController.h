...
@interface T1ComposeController : NSObject <T1TweetComposeViewControllerDelegate, T1ComposeViewControllerDelegate, T1CameraContainerViewControllerDelegate, T1PhotoPickerViewControllerDelegate>
{
...
- (void)_performDismissCompletion:(_Bool)arg1;
- (void)composeViewController:(id)arg1 dismissAnimated:(_Bool)arg2 compositionSent:(_Bool)arg3;
...
- (void)presentComposerFromViewController:(id)arg1 aniamted:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
