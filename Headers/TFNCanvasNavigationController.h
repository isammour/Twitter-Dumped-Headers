...
@class NSString, TFNCanvasTransitionAnimator, TFNCanvasViewController, TFNCustomHitTestView, TFNToolbar;
...
@property(readonly, nonatomic) TFNCanvasViewController *canvasViewController;
