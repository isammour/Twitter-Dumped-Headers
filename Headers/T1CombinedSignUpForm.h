...
@class NSDate, NSDateFormatter, NSString, TFNDatePicker, TFNFormField, UIBarButtonItem;
...
- (id)private_toolbarItemsWithLeftItem:(id)arg1 accessoryItem:(id)arg2;
...
- (id)initWithName:(id)arg1 hint:(id)arg2 phone:(id)arg3 email:(id)arg4 phoneOrEmailHint:(id)arg5 birthday:(id)arg6 hint:(id)arg7 explanation:(id)arg8 useDevicePrefill:(_Bool)arg9 delegate:(id)arg10;
- (id)initForReviewWithName:(id)arg1 phone:(id)arg2 email:(id)arg3 birthday:(id)arg4 delegate:(id)arg5;
