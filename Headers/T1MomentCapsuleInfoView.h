...
@class CALayer, NSString, T1MomentCalculatedMediaRenderLayoutView, T1MomentCapsuleInfoViewTheme, T1MomentCapsuleLoadingView, TFNAttributedTextView, TFNButton, TFNTwitterAccount, UIButton, UIImage, UIImageView, UILabel;
@protocol T1MomentCapsuleInfoViewDelegate, T1MomentCapsuleInfoViewLayoutDelegate, T1MomentViewModel;

@interface T1MomentCapsuleInfoView : UIView <TFNTwitterImageViewFetchHelperDelegate>
{
    UILabel *_titleLabel;
