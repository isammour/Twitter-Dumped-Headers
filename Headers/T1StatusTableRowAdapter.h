...
@class NSMutableDictionary, NSString, T1StatusLiveEngagementManager, T1StatusMediaHandler, T1StatusMediaTimelineObserver, T1StatusPromotedImpressionHandler, T1StatusTableSlideshowManager, T1StatusTableWebManager, TFNDataViewController, TFNTwitterDisplaySessionManager;

@interface T1StatusTableRowAdapter : TFNItemsTableRowAdapter <T1StatusViewEventScribeHandler, TFNCellVisibilityBroadcasterDelegate, TNLCommunicationAgentObserver>
{
    ...
    NSMutableDictionary *_carouselViewControllers;
...
@property(retain, nonatomic) NSMutableDictionary *statusDwellState; // @synthesize statusDwellState=_statusDwellState;
...
@property(retain, nonatomic) NSMutableDictionary *carouselViewControllers; // @synthesize carouselViewControllers=_carouselViewControllers;
...
- (void)_removeCarouselViewControllerForUnifiedID:(id)arg1;
...
- (void)_hashflagVersionDidChange;
- (void)_t1_setNeedsReloadIfLayoutRequiresReloadForCellLayoutObjectIdentifier:(id)arg1;
- (void)_t1_setNeedsReloadIfLayoutRequiresReloadForCellLayoutObjectAtIndexPath:(id)arg1;
...
- (unsigned long long)_tableViewController:(id)arg1 statusOptionsForViewModel:(id)arg2 withOptions:(id)arg3 atIndexPath:(id)arg4;
