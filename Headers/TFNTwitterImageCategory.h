...
+ (_Bool)_tfn_parseBannerURLFormatWithURLComponents:(id)arg1 extension:(id)arg2 format:(out id *)arg3 variantName:(out id *)arg4;
+ (_Bool)_tfn_parseAvatarURLFormatWithURLComponents:(id)arg1 extension:(id)arg2 format:(out id *)arg3 variantName:(out id *)arg4;
+ (_Bool)_tfn_parseLegacyURLFormatWithURLComponents:(id)arg1 extension:(id)arg2 format:(out id *)arg3 variantName:(out id *)arg4;
+ (_Bool)_tfn_parseModernURLFormatWithURLComponents:(id)arg1 extension:(id)arg2 format:(out id *)arg3 variantName:(out id *)arg4;
...
+ (CDStruct_4ace6bb3)variantSelectionBehavior;
...
- (id)fetchRequestForImageTemplateURL:(id)arg1 originalDimensions:(struct CGSize)arg2 targetDimensions:(struct CGSize)arg3 targetContentMode:(long long)arg4 maximumVariantDimensions:(struct CGSize)arg5;
- (id)variantForImageWithOriginalDimensions:(struct CGSize)arg1 targetDimensions:(struct CGSize)arg2 targetContentMode:(long long)arg3 maximumVariantDimensions:(struct CGSize)arg4 placeholder:(_Bool)arg5 selectionBehavior:(CDStruct_4ace6bb3)arg6;
