...
@interface TFSTwitterAPICallbackCommand : TFSTwitterAPICommand
{
    NSString *_path;
}
...
- (void).cxx_destruct;
- (id)request;
- (id)initWithService:(id)arg1 accountID:(id)arg2 endpointPath:(id)arg3 source:(unsigned long long)arg4 completionBlock:(CDUnknownBlockType)arg5;
