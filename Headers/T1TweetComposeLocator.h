...
@interface T1TweetComposeLocator : NSObject <TFNTwitterPOISuggesterDelegate, T1PlacePickerViewControllerDelegate, TFNTwitterAutoGeotaggerDelegate, TFNTwitterAuthenticated>
{
