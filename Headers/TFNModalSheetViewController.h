...
@interface TFNModalSheetViewController : UIViewController <UIGestureRecognizerDelegate, TFNLayoutMetricsEnvironment, TFNModalContainerViewController, TFNPopoverSourceSpecification>
{
    ...
    double _initialPreferredHeight;
...
@property(nonatomic) double initialPreferredHeight; // @synthesize initialPreferredHeight=_initialPreferredHeight;
...
- (void)_dismissAnimated:(_Bool)arg1 fromGesture:(_Bool)arg2 duration:(double)arg3 velocity:(double)arg4 completion:(CDUnknownBlockType)arg5;
...
- (struct CGSize)_modalContentSizeForFloatingLayoutModeWithAvailableSize:(struct CGSize)arg1 getMaximumSize:(out struct CGSize *)arg2;
...
- (void)_updateCurrentHeight:(double)arg1 shouldPerformLayoutModeTransition:(_Bool)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
