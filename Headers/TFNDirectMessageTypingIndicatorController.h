...
@protocol TFNDirectMessageConversation, TFNDirectMessageConversationEntry, TFNDirectMessageTypingIndicatorControllerDelegate;
...
@property(retain, nonatomic) id <TFNDirectMessageConversationEntry> latestEntry; // @synthesize latestEntry=_latestEntry;
