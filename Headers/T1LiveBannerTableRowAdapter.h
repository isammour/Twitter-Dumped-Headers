...
@class NSMapTable, NSString, T1LiveBannerScribe, T1MultiEventLiveBannerView, TFNActionSheetController, TFNTwitterMediaImagePipeline;
...
@interface T1LiveBannerTableRowAdapter : TFNItemsTableRowAdapter <T1MultiEventLiveBannerViewDelegate>
{
    ...
    TFNActionSheetController *_currentActionSheetController;
...
@property(nonatomic) __weak TFNActionSheetController *currentActionSheetController; // @synthesize currentActionSheetController=_currentActionSheetController;
...
- (id)initWithLiveBannerScribe:(id)arg1 delegate:(id)arg2;
