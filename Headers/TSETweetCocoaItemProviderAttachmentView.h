...
@class NSObject, TSETweetAttachmentCocoaItemProvider, TSETweetAttachmentView, UIActivityIndicatorView;
...
- (void)updateWithURL:(id)arg1 title:(id)arg2 previewImage:(id)arg3;
- (void)_tseui_loadMetadataForURLWithCompletion:(CDUnknownBlockType)arg1;
- (void)startLoadingAttachmentIfNeeded;
- (void)_tseui_loadImageWithOptions:(id)arg1 attachmentImageHandler:(CDUnknownBlockType)arg2;
- (id)_tseui_previewImageOptionsForMaxImageSize:(struct CGSize)arg1;
