...
@class NSString, NSURL, NSURLRequest, T1OpenExternalURLSessionManager, TFSKVODispatcher, TNLRequestOperation, UIBarButtonItem, UIProgressView, UIWindow, WKWebView;
...
@property(nonatomic) _Bool usingNonPersistentDataStore; // @synthesize usingNonPersistentDataStore=_usingNonPersistentDataStore;
...
- (_Bool)shouldStartLoadingRequest:(id)arg1 navigationType:(long long)arg2;
