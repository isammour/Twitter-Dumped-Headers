...
@class NSArray, NSMutableArray, NSString, T1TaggingTableHeaderView, T1TaggingTableView, TFNTwitterAccount, TFNTwitterAutocompleteResultsController, TFNTwitterComposition, TFSTimer;
