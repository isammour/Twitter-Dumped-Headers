...
@class CALayer, CAShapeLayer, NSIndexPath, NSString, TFNDataViewCellLayout, UIColor, UIImageView, UITableView, UIView;
...
@interface TFNTableViewCell : UITableViewCell <TFNDataViewCell>
{
    ...
    _Bool _previousCellHasDifferentBackgroundColor;
    _Bool _initialized;
