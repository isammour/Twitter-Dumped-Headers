...
@interface T1NetworkTrafficMappingServiceProbingTask : NSObject <TFSTwitterRecurringTask>
{
...
- (void)_t1_queue_triggerWithURLStrings:(id)arg1 completion:(CDUnknownBlockType)arg2;
