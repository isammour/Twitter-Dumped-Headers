...
@class NSArray, NSMutableArray, NSString, NSURL, T1AmbientNotificationViewController, T1WebViewLogger, T1WebViewRedirectTracker, TFNBarButtonItem, TFNTwitterAccount, TFNTwitterStatus, TFNTwitterURLParserResult, UINavigationBar, UIView, UIViewController;

@interface T1WebViewController : T1BaseWebViewController <TFNTwitterAuthenticated, T1AmbientNotificationDelegate, TFNPresented, T1JumpBackToHomeTimelineBehavior, T1WebBrowserViewController>
{
    ...
    _Bool _isWebPromptExperimentEnabled;
...
@property(readonly, nonatomic) _Bool presentAsPageSheet; // @synthesize presentAsPageSheet=_presentAsPageSheet;
