...
@interface TFSModelCache : NSObject
{
    ...
    NSString *_diskCacheDirectoryPath;
...
+ (void)removeCacheFilesExcludingAccountIdentifiers:(id)arg1 configuration:(id)arg2;
...
+ (id)fileSizeOperationWithConfiguration:(id)arg1 completion:(CDUnknownBlockType)arg2;
...
@property(readonly, nonatomic) NSString *diskCacheDirectoryPath; // @synthesize diskCacheDirectoryPath=_diskCacheDirectoryPath;
...
- (id)searchAmongResults:(id)arg1 withKey:(id)arg2 operator:(long long)arg3 value:(id)arg4;
- (id)unenqueuedSearchOperationWithKey:(id)arg1 operator:(long long)arg2 values:(id)arg3 resultCountLimit:(long long)arg4 cancellationCheckBlock:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
- (id)unenqueuedSearchOperationWithKey:(id)arg1 operator:(long long)arg2 value:(id)arg3 resultCountLimit:(long long)arg4 cancellationCheckBlock:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
