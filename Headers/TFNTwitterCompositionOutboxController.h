...
- (void)_tfn_main_didCancelUploadComposition:(id)arg1 index:(unsigned long long)arg2 count:(unsigned long long)arg3;
...
- (void)_tfn_main_unsafeRemoveOutboxComposition:(id)arg1;
- (_Bool)_tfn_main_deleteCompositionInOutboxIfExists:(id)arg1;
- (void)_tfn_main_deleteCompositionInOutbox:(id)arg1;
- (void)_tfn_main_unsafeMoveOutboxCompositionToDrafts:(id)arg1;
- (_Bool)_tfn_main_cancelCompositionToDraftIfExists:(id)arg1;
- (void)_tfn_main_cancelCompositionToDraft:(id)arg1;
