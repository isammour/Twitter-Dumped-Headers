...
@interface T1ResizableHeaderViewController : TFNViewController <TFNLayoutMetricsEnvironment, UIDropInteractionDelegate, T1TweetDraftsViewControllerDelegate, T1ResizableHeaderViewDelegate, TFNNavigationControllerTransitionProvider>
{
    ...
    _Bool _shouldBounce;
    _Bool _shouldAdjustToExpandedSizeChangesWhenCollapsed;
...
@property(nonatomic) _Bool shouldAdjustToExpandedSizeChangesWhenCollapsed; // @synthesize shouldAdjustToExpandedSizeChangesWhenCollapsed=_shouldAdjustToExpandedSizeChangesWhenCollapsed;
