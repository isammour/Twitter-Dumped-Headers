...
@class CALayer, NSString, T1AudioEqualizerAnimationView, UIColor, UIFont, UIImage, UIImageView, UILabel;
...
@interface T1PillView : UIView
{
    ...
    unsigned long long _iconAnimation;
    UIImage *_iconImage;
    CALayer *_backgroundLayer;
    UIImageView *_iconView;
    T1AudioEqualizerAnimationView *_audioEqualizerView;
    UILabel *_textLabel;
...
@property(readonly, nonatomic) T1AudioEqualizerAnimationView *audioEqualizerView; // @synthesize audioEqualizerView=_audioEqualizerView;
...
@property(readonly, nonatomic) unsigned long long iconAnimation; // @synthesize iconAnimation=_iconAnimation;
...
- (void)setIconWithAnimation:(unsigned long long)arg1 animated:(_Bool)arg2;
- (void)setIconWithImage:(id)arg1 animated:(_Bool)arg2;
- (void)setIconVisible:(_Bool)arg1 animated:(_Bool)arg2;
@property(readonly, nonatomic, getter=isIconViewAnimating) _Bool iconViewAnimating;
- (id)currentIconView;
- (void)setTextBackgroundColor:(id)arg1 animated:(_Bool)arg2;
- (_Bool)textLabelHidden;
