...
@class NSString, TFNAttributedTextView, TFNTouchDownGestureRecognizer, TFNTwitterAccount, TFSTwitterTagSet, UIColor, UIFont, UIGestureRecognizer, UIImage, UIImageView;
...
+ (struct CGSize)sizeForTagSet:(id)arg1 account:(id)arg2 font:(id)arg3 boldFont:(id)arg4 icon:(id)arg5 singleLine:(_Bool)arg6 summarize:(_Bool)arg7 showAccountUserFirst:(_Bool)arg8 selectionEnabled:(_Bool)arg9 highlightEnabled:(_Bool)arg10 inWidth:(double)arg11;
