...
@class NSMutableArray, NSString, T1ProfileAvatarImageView, TFNTwitterAccount, TFNTwitterUserDataSource, UIImage, UITapGestureRecognizer;
...
- (void)_userDataSourceDidUpdate;
- (void)setHeaderSubtitle:(id)arg1 animated:(_Bool)arg2;
- (void)_updateAvatarViewStyle;
...
- (id)initWithFrame:(struct CGRect)arg1 maxPosition:(unsigned long long)arg2;
