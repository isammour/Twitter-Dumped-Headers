...
@interface TFNTwitterCustomTimelineList : NSObject
{
    ...
    } _customTimelineListFlags;
    _Bool _showsFollowing;
...
@property(nonatomic) _Bool showsFollowing; // @synthesize showsFollowing=_showsFollowing;
...
- (void)_loadNextWithResponseBlock:(CDUnknownBlockType)arg1;
- (void)_sortTimeline;
